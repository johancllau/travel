   ...
   ?>
    ...
    <?php
      ...
      if(isset($_POST['cari'])){
        ...
        d.id_destinasi, mt.kapasitas, mt.image_travell
      ...
      $select = "SELECT pt.id_paket_tour, pt.nama_paket, pt.daftar_destinasi, 
      pt.harga_paket, pt.description, mt.kapasitas, mt.image_travell
      FROM paket_tour AS pt
